...
import 'package:chroma_plus_flutter/color_picker/utils.dart';
...
class _ColorPickerLabelState extends State<ColorPickerLabel> {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
      DropdownButton(
        dropdownColor: AppConstants.altColor,
        value: _colorType,
        ...
        items: [
          for (ColorLabelType type in widget.colorLabelTypes)
            DropdownMenuItem(
              value: type,
              child: Text(type.toString().split('.').last.toUpperCase(),style: TextStyle(color: Colors.white, backgroundColor: AppConstants.altColor),),
            )
        ],
      ),
